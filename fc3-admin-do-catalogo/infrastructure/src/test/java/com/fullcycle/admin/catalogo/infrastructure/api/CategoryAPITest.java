...
public class CategoryAPITest {
        ...
        public void givenAValidId_whenCallsGetCategory_shouldReturnCategory() throws Exception {
                ...
                when(getCategoryByIdUseCase.execute(any()))
                                .thenThrow(DomainException.with(new Error("Category with ID %s was not found"
                ...
                response.andExpect(status().isOk())
                                ...
                                .andExpect(jsonPath("$.updated_at", equalTo(aCategory.getUpdateAt().toString())))
        ...
        @Test
        public void givenAInvalid_whenCallsGetCategory_shouldReturnNotFound() throws Exception {
                // given
