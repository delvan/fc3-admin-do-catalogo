...
public class ListCategoryUseCaseIT {
        ...
        void mockUp() {
                ...
                final var caterories = Stream.of(
                ...
                categoryRepository.saveAllAndFlush(caterories);

        }

        @Test
        public void givenAValidTerm_whenTermDoesntMatchsPrePersited_shouldReturnEmptyPage() {

                final var expectedPage = 0;
                final var expectedPerPage = 10;
                final var expectedTerms = "saddfgdgdfg";
        ...
        public void givenAValidSortAndDirection_whenCallsListCategories_thenShouldReturnCategoryOrdered(
